...
class human_relations:
    ...
    def __init__(self):
        ...
        self.time_pub = rospy.Publisher('select_elem', String, queue_size=10)
    ...
    def time_select(self, okao_id):
        self.select_msg = "["
        time_qy = "SELECT DISTINCT time_stamp FROM data1.`"+\
                   self.r_name+"`"
        print time_qy
        ...
        for row in res:
            self.select_msg = self.select_msg + str(row[0]) + ", "
